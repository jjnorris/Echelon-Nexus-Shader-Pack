// ============================================================================
// COMPOSITE2 SHADER - Phase 3: Quantum-Inspired Sampling
...
//
// Reads from: composite1 (previous pass), history (temporal buffer)
...
uniform sampler2D composite;        // Current frame composite (Phase 2 result from composite1)
